...
<body style="font-family: sans-serif; line-height: 1.5; color: #374151;">
    <h2 style="margin-bottom: 8px;">Citas programadas para {{ $date->format('d/m/Y') }}</h2>
    <p style="color: #6b7280; font-size: 14px;">Reporte automático para administración.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 16px; font-size: 14px;">
            <thead>
                <tr style="background: #f3f4f6;">
                    ...
                    <th style="border: 1px solid #e5e7eb; padding: 8px; text-align: left;">Doctor</th>
            ...
            <tbody>
                @foreach($appointments as $appointment)
                    <tr>
                        ...
                        <td style="border: 1px solid #e5e7eb; padding: 8px;">{{ $appointment->doctor->user->name }}</td>
